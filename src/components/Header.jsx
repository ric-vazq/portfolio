...
export default function Header() {
  ...
  return (
    <div
      className={`hero min-h-screen aspect-960/300 bg-cover bg-no-repeat waves`}
    >
      <div className="hero-content flex-col lg:flex-row-reverse gap-10">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-start">
          ...
          <Link
            to={"/contact"}
            className="btn btn-accent text-accent-content lg:btn-primary lg:text-primary-content"
          >
            Contact
          </Link>
        </div>
