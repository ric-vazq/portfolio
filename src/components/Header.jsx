    ...
    <div className="hero min-h-screen bg-base-200">
      <div className="hero-content flex-col lg:flex-row-reverse gap-10">
        <div className="flex flex-col items-center gap-10 lg:gap-4 lg:flex-col-reverse p-0">
          ...
          <LazyLoadImage src={photo} className="rounded-full w-96 bg-secondary animate-fade-left animate-duration-1000 animate-ease-in hover:cursor-pointer" onClick={()=>{navigate("/about-me")}}/>
        </div>
